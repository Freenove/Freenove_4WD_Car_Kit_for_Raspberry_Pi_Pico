...
.. literalinclude:: ../../../freenove_Kit/Ordinary_wheels/Sketches/06.1_WiFi_APP_TcpServer/06.1_WiFi_APP_TcpServer.ino
    :linenos:
    :language: c
    :dedent:
...
.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_10.png
    :align: center
...
.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_11.png
    :align: center

.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_12.png
    :align: center
...
Open the folder “06.2_Multi_Functional_Car” in Freenove_4WD_Car_Kit_for_Raspberry Pi Pico\\Ordinary_wheels\\Sketches and double click “06.2_Multi_Functional_Car.ino”.
...
.. literalinclude:: ../../../freenove_Kit/Ordinary_wheels/Sketches/06.2_Multi_Functional_Car/06.2_Multi_Functional_Car.ino
    :linenos:
    :language: c
    :dedent:
...
.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_14.png
    :align: center

.. note::
    
    You Can See the control end of the car, but this time need to click on the lower right corner of the button “Wheel” to enter our car control interfaceThe function of the client is as follows:

.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_15.png
    :align: center
...
.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_16.png
    :align: center

Select Python3.8.1.

.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_17.png
    :align: center
...
.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_18.png
    :align: center

Check all the options and then click “Next”.

.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_19.png
    :align: center
...
.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_20.png
    :align: center

Wait for it to finish installing.

.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_21.png
    :align: center

Now the installation is finished.

.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_22.png
    :align: center
...
.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_23.png
    :align: center
...
.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_24.png
    :align: center
...
.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_25.png
    :align: center

2. Input “Python setup_windows.py” and press enter. If it fails, you can input “Python3 setup_windows.py” to try again.

.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_26.png
    :align: center
...
.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_27.png
    :align: center
...
.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_28.png
    :align: center

2.	Input “Python main.py” and press enter. If it fails, you can input “Python3 main.py” to try again. 

.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_29.png
    :align: center
...
.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_30.png
    :align: center
...
.. table:: 
    ...
    | SliderBar |                                                    Function                                                     |
    +===========+=================================================================================================================+
    | Servo 1   | SliderBar Servo 1 is used to slightly adjust the angle. If the servo is not fully centered during installation, |
    |           |                                                                                                                 |
...
.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_31.png
    :align: center

At the bottom of the page, click macOS 64-bit installer and download installation package.

.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_32.png
    :align: center

Click Continue.

.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_33.png
    :align: center

Click Continue

.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_34.png
    :align: center

Click Agree.

.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_35.png
    :align: center

Click Install. If your computer has a password, enter the password and Install Software.

.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_36.png
    :align: center

Now the installation succeeds.

.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_37.png
    :align: center

You can find it in Applications.

.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_38.png
    :align: center
...
.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_39.png
    :align: center
...
.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_40.png
    :align: center
...
.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_41.png
    :align: center
...
.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_42.png
    :align: center
...
.. image:: ../_static/imgs/Standard/7_WiFi_Car(Only_for_Pico_W)/Chapter07_43.png
    :align: center

The way to control macOS System client is the same as Windows (:ref:`Control <fnk0089/codes/standard/7_wifi_car(only_for_pico_w):control the car with keyboard>`).