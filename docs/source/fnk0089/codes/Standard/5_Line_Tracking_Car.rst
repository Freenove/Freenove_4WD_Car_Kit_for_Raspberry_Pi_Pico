...
Open the folder “04.1_Tracking_Sensor” in “Freenove_4WD_Car_Kit_for_Raspberry_Pi_Pico\\Ordinary_wheels\\Sketches” and double click “04.1_Tracking_Sensor.ino”.

Code
--------------------------------------

.. literalinclude:: ../../../freenove_Kit/Ordinary_wheels/Sketches/04.1_Tracking_Sensor/04.1_Tracking_Sensor.ino
    :linenos:
    :language: c
    :dedent:
...
.. image:: ../_static/imgs/Standard/5_Line_Tracking_Car/Chapter05_01.png
    :align: center
...
.. literalinclude:: ../../../freenove_Kit/Ordinary_wheels/Sketches/04.2_Track_Car/04.2_Track_Car.ino
    :linenos:
    :language: c
    :dedent:
...
.. note::
    ...
    The tracks made of black tape vary among individuals. If your car cannot move along the black tape, you can modify the parameters in Motor_Move().