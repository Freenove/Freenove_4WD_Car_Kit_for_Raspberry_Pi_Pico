...
Next, we download the code to Raspberry Pi Pico W to test the photoresistors. Open the folder “03.1_Photosensitive” in “Freenove_4WD_Car_Kit_for_Raspberry_Pi_Pico\\Ordinary_wheels\\Sketches” and double click “03.1_Photosensitive.ino”

Code
------------------------------

.. literalinclude:: ../../../freenove_Kit/Ordinary_wheels/Sketches/03.1_Photosensitive/03.1_Photosensitive.ino
    :linenos:
    :language: c
    :dedent:
...
.. literalinclude:: ../../../freenove_Kit/Ordinary_wheels/Sketches/03.2_Photosensitive_Car/03.2_Photosensitive_Car.ino
    :linenos:
    :language: c
    :lines: 1-20
    :dedent:
...
.. literalinclude:: ../../../freenove_Kit/Ordinary_wheels/Sketches/03.2_Photosensitive_Car/Freenove_4WD_Car_For_Pico_W.cpp
    :linenos:
    :language: c
    :lines: 252-269
    :dedent:
